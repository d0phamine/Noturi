	...
	theme: {
		extend: {
			tokens: {
				...
				fonts: {
					body: {
						value: "'JetBrains Mono Variable', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif"
					},
					heading: {
						value: "'JetBrains Mono Variable', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif"
					},
					mono: {
						value: "'JetBrains Mono Variable', 'SFMono-Regular', Menlo, Monaco, Consolas, monospace"
					}
				},
				fontSizes: {
					xs: { value: "0.75rem" },
				...
				durations: {
					ultraFast: { value: "50ms" },
					faster: { value: "100ms" },
					fast: { value: "150ms" },
					normal: { value: "200ms" },
					slow: { value: "300ms" },
					slower: { value: "400ms" },
					ultraslow: { value: "500ms" }
				},
				easings: {
			...
			// Semantic tokens для темной темы
			semanticTokens: {
				colors: {
					bg: {
						primary: {
